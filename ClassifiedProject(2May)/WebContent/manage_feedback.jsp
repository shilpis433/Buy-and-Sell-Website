...
<div class="rounded" style="position:absolute;left:18%;top:25%;width:70%;border-style:groove;text-align: center;overflow:scroll;">
...
<%
	...
	%>
	  <tr>
	      ...
	      <td><a href="update_feedback.jsp?f_id=<%=rs.getInt(1)%>">Update</a> | <a href="delete_feedback_db.jsp?f_id=<%=rs.getInt(1)%>">Delete</a></td>
	    </tr>
